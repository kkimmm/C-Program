...
{
    xmove[0].x = 0;  xmove[0].y =1;//往正上方移动
    xmove[1].x = 1;  xmove[1].y =1;//往左上方移动
    xmove[2].x = 1;  xmove[2].y =0;//往正右方移动
    xmove[3].x = 1;  xmove[3].y =-1;//往右下方移动...后面依次顺时针方向移动一格
